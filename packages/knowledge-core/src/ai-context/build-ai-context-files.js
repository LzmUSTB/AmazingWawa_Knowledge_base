...
const STATIC_CONTEXT_FILES = {
  ...
  "conflictResolution": {
    ...
    "addNodeNestedNodeObjectOverridesFlatAmbiguousExamples": true,
    "topLevelTypeIsOperationOnly": true,
    "nodeKnowledgeTypeGoesInNodeDotTypeOrFlatNodeType": true,
    "contentFormatNoneMeansNoNoteFile": true,
    "localeTitleRecommendedButOptional": true,
    "sourceBlocksConditional": true,
    "noDirectOriginalSourceMediaWarningDisabled": true,
    "visibleInteractiveElementWarningKept": true,
    "assetPathWhitelistMandatory": true,
    "unreferencedPackagedAssetsWarn": true
  }
}),
};
...
function buildAiContextYaml(vault, domains, nodes, edges, customBlocks) {
  const context = {
    ...
    constraints: {
      ...
      patchShape: {
        addNodePreferred: "nested-node-object",
        addNode: {
          operationTypeField: "type",
          operationTypeValue: "add_node",
          nodeObjectField: "node",
          nodeKnowledgeTypeField: "node.type",
          flatCompatibilityKnowledgeTypeField: "nodeType",
          forbidDuplicateTypeKeys: true,
          forbidTopLevelTypeAsKnowledgeType: true,
        },
        addDomainPreferred: "nested-domain-object",
        addEdge: "flat-top-level-from-to-relation",
      },
      localeTitle: {
        titleRequired: true,
        titleLanguage: "English or canonical technical English",
      ...
      htmlRichNote: {
        ...
        sourceBlockPolicy: "conditional: required only when source/network material is actually cited, embedded, closely paraphrased, or used as evidence",
