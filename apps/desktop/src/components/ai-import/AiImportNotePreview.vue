...
.note-preview-surface.is-html-preview {
  display: flex;
  overflow: hidden;
}

.note-preview-surface.is-html-preview :deep(.html-note-renderer) {
  display: flex;
  flex: 1 1 auto;
  min-width: 0;
  min-height: 0;
...
.note-preview-surface.is-html-preview :deep(.html-note-frame) {
  flex: 1 1 auto;
  min-width: 0;
